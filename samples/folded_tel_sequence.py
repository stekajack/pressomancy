...
quartet_config = Quartet.config.specify(sigma=sigma, size=sigma, bond_handle=bond_hndl,type='broken', espresso_handle=sim_inst.sys)
...
quadriplex_config_list = [Quadriplex.config.specify(sigma=5., associated_objects=elem, espresso_handle=sim_inst.sys, bonding_mode='ftf',bond_handle=bond_quad, size=6.) for elem in grouped_quartets]
...
tel_config_list = [TelSeq.config.specify(sigma=6, n_parts=part_per_filament, espresso_handle=sim_inst.sys, associated_objects=elem, size=6*part_per_filament,bond_handle=bond_quad,diag_bond_handle=diag_bond) for elem in grouped_quadriplexes]
